...
use Satupersen\Database\Schema\Grammars\Grammar;
use Satupersen\Database\SQLiteConnection;
...
class Blueprint
{
     ...
     *
     * @var \Satupersen\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @return \Satupersen\Support\Fluent
     */
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Satupersen\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Satupersen\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Satupersen\Database\Schema\ForeignIdColumnDefinition
     */
